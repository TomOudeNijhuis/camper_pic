...
set(camper_pic_default_default_XC8_FILE_TYPE_assemble)
set_source_files_properties(${camper_pic_default_default_XC8_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${camper_pic_default_default_XC8_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(camper_pic_default_default_XC8_FILE_TYPE_assemblePreprocess)
set_source_files_properties(${camper_pic_default_default_XC8_FILE_TYPE_assemblePreprocess} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${camper_pic_default_default_XC8_FILE_TYPE_assemblePreprocess})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(camper_pic_default_default_XC8_FILE_TYPE_compile
...
set_source_files_properties(${camper_pic_default_default_XC8_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(camper_pic_default_default_XC8_FILE_TYPE_link)
set(camper_pic_default_image_name "default.elf")
set(camper_pic_default_image_base_name "default")

# The output directory of the final image.
set(camper_pic_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/camper_pic")

# The full path to the final image.
set(camper_pic_default_full_path_to_image ${camper_pic_default_output_dir}/${camper_pic_default_image_name})
...
set(output_extensions
    ...
    .sym
    .cmf)
list(TRANSFORM output_extensions PREPEND "${camper_pic_default_output_dir}/${camper_pic_default_image_base_name}")
